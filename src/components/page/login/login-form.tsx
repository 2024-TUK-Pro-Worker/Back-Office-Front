  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 gap-2">
        <a className="flex items-center justify-center h-20 grow btn" onClick={() => {location.href=`${process.env.NEXT_PUBLIC_API_ENDPOINT}/auth/google/login?nocache=${(new Date()).getTime()}`;}}>
